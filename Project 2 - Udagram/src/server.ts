...
(async () => {
  ...
  app.get("/filteredImage", async (req, res) => {
     ...
     */
    if (!image_url) {
      return res.status(400).send("QUERY Parameter 'image_url' query was not supplied. Please type a valid image URL after the = sign in http://localhost:{PORT}/filteredimage?image_url= ")
